            ...
            html.Div(
                ...
                children=[
                    dcc.Dropdown(
                        ...
                        options=[
                            {"label": s, "value": s} for s in state.get_plots("data")
                        ],
...
def create_right_column(state) -> html.Div:
    ...
    return html.Div(id="right-column-data", children=explanation_views)
...
def create_data_explanation_layout(state) -> html.Div:
    return html.Div(
        ...
        children=[
            ...
            # Right column
            html.Div(className="nine columns", children=create_right_column(state)),
        ],
    )
