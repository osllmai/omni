...
class State:
    ...
    def __init__(self):
        ...
        self.explanations = {view: {} for view in State.views}
        self.state_params = {
            "num_figures_per_row": {},
            "plots": {},
            "display_plots": {},
    ...
    def set(
        ...
        self.instance_indices = (
            list(range(self.instances.num_samples())) if instances is not None else []
        )
...
class WhatifState:
    ...
    def set(
        ...
        self.state_params["display_plots"] = [
            name for name in local_explanations.keys()
        ]
